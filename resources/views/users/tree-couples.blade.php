                                ...
                                <div class="entry {{ $ggcCount == 1 ? 'sole' : '' }}">
                                    ...
                                    <div class="branch lv5">
                                        ...
                                        <div class="entry {{ $ggccCount == 1 ? 'sole' : '' }}">
                                            @include('users.partials.tree-couples-label',['sunah'=>$ggcc])
                                            ...
                                            <div class="branch lv6">
                                                ...
                                                <div class="entry {{ $udhegCount == 1 ? 'sole' : '' }}">
                                                    @include('users.partials.tree-couples-label',['sunah'=>$udheg])
                                                </div>
                                                @endforeach
                                            </div>
                                            @endif
...
<link rel="stylesheet" href="{{ asset('css/tree-with-couples.css') }}">
@endsection
