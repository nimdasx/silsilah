<div class="pull-right btn-group" role="group">
    ...
    {{ link_to_route('users.tree-couples', trans('app.show_family_tree_with_couples'), [$user->id], ['class' => Request::segment(3) == 'tree-couple' ? 'btn btn-default active' : 'btn btn-default']) }}
